...
log = logging.getLogger("dblcheck.vault")
...
def get_secret(path: str, key: str, fallback_env: str = "") -> str | None:
    ...
    Args:
        path:         KV path without the 'secret/' prefix, e.g. 'dblcheck/router'
...
def credential_source() -> str:
    ...
    if "dblcheck/router" not in _cache:
        ...
        get_secret("dblcheck/router", "username", "ROUTER_USERNAME")
    cached = _cache.get("dblcheck/router")
